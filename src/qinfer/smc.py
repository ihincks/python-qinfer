...
class ReparameterizedSMCUpdater(SMCUpdater):
    def __init__(self,
            model, n_particles, prior,
            resampler=None, resample_thresh=0.5,
            debug_resampling=False,
            track_resampling_divergence=False,
            zero_weight_policy='error', zero_weight_thresh=None,
            canonicalize=True,
            resampler_uses_natural = False,
            timestep_update_uses_natural = False,
            prior_uses_natural = True,
            likelihood_uses_natural = True
        ):
        super(ReparameterizedSMCUpdater, self).__init__(
            model, n_particles, prior,
            resampler=resampler, resample_thresh=resample_thresh,
            ...
            zero_weight_thresh=zero_weight_thresh,
